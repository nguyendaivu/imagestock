/**
Backend script to handle the theme demo
**/
var Backend = function() {
    ...
    var handleTheme = function() {
        ...
        var setLayout = function() {
            ...
            var headerOption = $('.page-header-option', panel).val() || "fixed";
        ...
        var setColor = function(color) {
            ...
            $('#style-color').attr("href", Layout.getLayoutCssPath() + 'themes/' + color_ + ".css");
            if (color == 'light2') {
    ...
    var setThemeStyle = function(style) {
        ...
        $('#style-components').attr("href", Metronic.getGlobalCssPath() + file + ".css");
    };
